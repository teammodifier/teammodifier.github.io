(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditTeamsComponent = /** @class */ (function () {
                function EditTeamsComponent(esportService, authService, isLoadingService) {
                    this.esportService = esportService;
                ...
                EditTeamsComponent.prototype.onToggle = function (i, event) {
                    var _this = this;
                    var team = {
                        _id: this.allTeams[i]._id,
                        isVerified: this.allTeams[i].isVerified
                    };
                    this.esportService.verifyTeam(team).subscribe(function (event) {
                        team.isVerified = _this.allTeams[i].isVerified = !_this.allTeams[i].isVerified;
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FetchTeamsComponent = /** @class */ (function () {
                function FetchTeamsComponent(esportService, authService, isLoadingService) {
                    this.esportService = esportService;
                    this.authService = authService;
                    this.isLoadingService = isLoadingService;
                    this.DATA_SOURCE = [];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                function AuthGuard(router, authService, isLoadingService, notification) {
                    this.router = router;
                    this.authService = authService;
                    this.isLoadingService = isLoadingService;
                    this.notification = notification;
                ...
                AuthGuard.prototype.canActivate = function (route, state) {
                    ...
                    if (this.authService.loggedIn()) {
                        ...
                        setTimeout(function () {
                            _this.isLoadingService.remove();
                            _this.notification.error('SILAHKAN LOGIN DULU.');
                            _this.router.navigate(["/auth/sign-in"]);
                        }, 1000);
                        return false;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EsportService = /** @class */ (function () {
                ...
                // PUT to verify team
                EsportService.prototype.verifyTeam = function (team) {
                    this.createAuthenticationHeaders();
                    // console.log(this.authToken, team);
                    return this.HTTP.put(this.baseURL + '/verifyTeam', team, { headers: this.options })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) { console.log(res); }));
                };
