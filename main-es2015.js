...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        ...
        this.router.events
            ...
            event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationError"])).subscribe(event => {
...
const appRoutes = [
    ...
    {
        path: 'esport',
        loadChildren: () => Promise.all(/*! import() | esport-esport-module */[__webpack_require__.e("common"), __webpack_require__.e("esport-esport-module")]).then(__webpack_require__.bind(null, /*! ./esport/esport.module */ "./src/app/esport/esport.module.ts")).then(m => m.EsportModule)
    },
    {
        path: 'auth',
