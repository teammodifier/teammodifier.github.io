...
let EditTeamsComponent = class EditTeamsComponent {
    constructor(breakpointObserver, esportService, authService, isLoadingService, notification, dialog) {
        ...
        this.isHandset$ = this.breakpointObserver
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(result => result.matches));
        this.DATA_SOURCE = [];
    ...
    // PUT newScore
    editScore(team) {
        const dialogRef = this.dialog.open(_dialog_box_dialog_box_component__WEBPACK_IMPORTED_MODULE_10__["DialogBoxComponent"], {
            width: '400px',
            height: '400px',
            data: team,
            disableClose: true
        ...
        dialogRef.afterClosed().subscribe(result => {
            this.isLoadingService.add(this.esportService.addScore(team).subscribe((data) => {
    ...
    onToggle(team, event) {
        ...
        this.isLoadingService.add(this.esportService.verifyTeam(team).subscribe((data) => {
            console.log(data);
            this.notification.success(data.message);
        })); // End of isLoading$
    }
...
let EsportModule = class EsportModule {
};
EsportModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [...ESPORT_COMPONENTS, _dialog_box_dialog_box_component__WEBPACK_IMPORTED_MODULE_9__["DialogBoxComponent"]],
        imports: [
...
let EsportRoutingModule = class EsportRoutingModule {
};
...
let FetchTeamsComponent = class FetchTeamsComponent {
    constructor(breakpointObserver, esportService, authService, isLoadingService) {
        this.breakpointObserver = breakpointObserver;
        this.esportService = esportService;
        this.authService = authService;
        this.isLoadingService = isLoadingService;
    ...
    ngOnInit() {
        ...
        this.esportService.getTeams().subscribe(res => {
            ...
            this.DATA_SOURCE = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](teamsList);
            this.DATA_SOURCE.paginator = this.paginator;
            this.DATA_SOURCE.sort = this.sort;
        });
        // apply loader OnInit service
